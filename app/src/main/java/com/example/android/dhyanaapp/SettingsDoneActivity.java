...
public class SettingsDoneActivity extends AppCompatActivity {
    ...
    public void stopTimer(View v) {
        String output = String.format("%02d:%02d:%02d", 0, 0, 0);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == 2404) {
            if (data != null) {
                ...
                Log.i("SettingsDoneActivity", "in onActivityResult.. method: " + value_tune + value_silent + value_timer);
            } else
                Log.i("SettingsDoneActivity", "in onActivityResult data is null");
        } else
            Log.i("SettingsDoneActivity", "in onActivityResult result not OK");
    ...
    private void setTimerText(int value) {
        if ((value >= 5) && (value <= 60)) {
            ...
            timerText.setText(String.format("%s%d:%s%d:00", hours < 10 ? "0" : "", hours, minutes < 10 ? "0" : "", minutes));
        }
    }
    ...
    public void displayTimer(long millis) {
        ...
        output = String.format("%02d:%02d:%02d", seconds / 3600,
